  ...
  return (
    ...
    >
      ...
      {isOpen && (
        ...
        >
          <li className="block px-4 py-2 text-sm text-white hover:bg-gray-700 hover:text-white focus:outline-none focus:bg-gray-700 focus:text-white">
            About
          </li>
          <Link
            href="/whos-who"
